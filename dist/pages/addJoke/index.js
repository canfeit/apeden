...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  _createClass(Index, [{
    ...
    value: function onSubmit(_ref3) {
      ...
      (0, _service.addJoke)({
        ...
        (0, _service.upsertUser)(_extends({}, userInfo, _index2.default.getSystemInfoSync())).catch(console.error);
  ...
  return Index;
}(_index.Component), _class.properties = {}, _class.$$events = ["onContent", "onSubmit"], _temp2);
