...
var _TaroComponentClass = (_dec = (0, _index3.connect)(function (_ref) {
  ...
  function _TaroComponentClass() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = _TaroComponentClass.__proto__ || Object.getPrototypeOf(_TaroComponentClass)).call.apply(_ref2, [this].concat(args))), _this), _this.$usedState = ["loopArray0", "dispatch", "users"], _this.config = {
      navigationBarTitleText: "段子手",
      enablePullDownRefresh: true
    }, _this.onPullDownRefresh = function () {
      (0, _service.getUsers)(_this.props.dispatch);
  ...
  _createClass(_TaroComponentClass, [{
    ...
    value: function componentDidShow() {
      (0, _service.getUsers)(this.props.dispatch);
    }
  }, {
    key: "_createData",
    value: function _createData() {
      ...
      ;
      var loopArray0 = this.__props.users ? this.__props.users.map(function (user) {
        user = {
          $original: (0, _index.internal_get_original)(user)
        };
        var $loopState__temp2 = user.$original.nickName ? "段子:" + user.$original.jokes : null;
        return {
