...
var _TaroComponentClass = (_temp2 = _class = function (_BaseComponent) {
  ...
  function _TaroComponentClass() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _TaroComponentClass.__proto__ || Object.getPrototypeOf(_TaroComponentClass)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "currentTabBar"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(_TaroComponentClass, [{
    ...
    value: function _createData() {
      ...
      ;
      var anonymousState__temp = [{ iconType: "bullet-list" }, { iconType: "image" }, { iconType: "add" }, { iconType: "heart" }, { iconType: "user" }];
...
}(_index.Component), _class.properties = {}, _class.$$events = ["handleClickTabBar"], _temp2);
